    ...
    <div class="panel panel-default">
        <div class="panel-body" style="padding:50px 0;">
            ...
            <div style="text-align:center;margin-top:50px;">
                ...
                <button class="btn btn-lg btn-primary btn-transaction-commit" data-url="<?php echo base_url('staff_manage/save'); ?>">提交</button>
                <a class="btn btn-lg btn-primary btn-back" href="<?php echo base_url('staff_manage/index'); ?>">返回</a>
            </div>
        </div>
    </div>
</form>
