...
<form class="form-horizontal form-transaction" action="" method="POST">
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="padding:50px 0;">
            ...
            <div class="form-group">
                    <?php if(isset($_GET['user_type']) && $_GET['user_type'] == 1):?>
                    <label class="col-md-3 control-label">操作类型</label>
                    <div class="col-md-8">
                        <label class="radio-inline">
                            <input type="radio" name="amount_type" value="1">会员本金
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="amount_type" value="2">会员佣金
                        </label>
                    </div>
                    <?php else:?>
                        <input name="amount_type" value="3" type="hidden">
                    <?php endif;?>
            </div>
            <div class="form-group">
            ...
            <div style="text-align:center;margin-top:50px;">
                <button class="btn btn-lg btn-primary btn-transaction-commit" data-url="<?php echo base_url('transaction/commit'); ?>">提交</button>
            </div>
        </div>
    </div>
</form>
